...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		P:    shimv2.NewProvider(btp.New(version.Version)()),
		Name: "btp",
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing btp cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"pulumi", "btp", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/tieyanfu/pulumi-btp",
	...
	prov.MustComputeTokens(tokens.SingleModule("btp_", mainMod,
